        ...
        <table width="600" cellpadding="0" cellspacing="0" border="0" style="background:#ffffff; border-radius:8px; overflow:hidden; box-shadow:0 2px 6px rgba(0,0,0,0.1);">
          <tr>
            <td style="background:#b7950b; padding:20px; text-align:center;">
              <img src="https://inaproperty.co.uk/logo.png" alt="INA Property Solutions" width="120" style="display:block; margin:0 auto;" />
            </td>
          </tr>
          <tr>
          ...
          <tr>
            <td style="background:#f1f1f1; padding:20px; font-size:12px; text-align:center; color:#777;">
              <p style="margin:0;">INA Property Solutions · London · +44 20 XXXX XXXX</p>
